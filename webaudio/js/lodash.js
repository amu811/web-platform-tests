...
;(function(window, undefined) {
  ...
  function debounce(func, wait, immediate) {
    ...
    return function() {
      ...
      timeoutId = after_timeout(delayed, wait);
   ...
   * @returns {Number} Returns the `after_timeout` timeout id.
   * @example
   *
  ...
  function delay(func, wait) {
    var args = slice.call(arguments, 2);
    return after_timeout(function() { func.apply(undefined, args); }, wait);
  }
  ...
  function defer(func) {
    ...
    return after_timeout(function() { func.apply(undefined, args); }, 1);
  }
  ...
  function throttle(func, wait) {
    ...
    return function() {
      ...
      if (remaining <= 0) {
        ...
        timeoutId = after_timeout(trailingCall, remaining);
      }
      return result;
    };
  }
